...
from errortext import __version__
...
setup(
    name="errortext",
    version=__version__,
    description="Provide error messages for Python exceptions, even if the original message is empty",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/roskakori/errortext",
    project_urls={
